...
1. Convert the dataframe from wide to 'long' format.Name the new dataframe as `tidyweather`, name the variable containing the name of the month as `month`, and the temperature deviation values as `delta`.
...
- Approximately how much time did you spend on this problem set: 18-20 hours
- What, if anything, gave you the most trouble: Sorting the order of the graphs in challenge 2
